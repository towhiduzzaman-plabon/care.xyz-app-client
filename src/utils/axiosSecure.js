...
n// Use Vite env variable for API base so the app works both locally and on the deployed site.
...
nif (import.meta.env.MODE === "production" && (!API_BASE || API_BASE.includes("localhost"))) {
...
nconst axiosSecure = axios.create({
